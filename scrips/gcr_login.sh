...
# Test push 
# docker pull artemis
# docker image tag artemis us-central1-docker.pkg.dev/$GOOGLE_PROJECT/artemis/artemis:2.0.0
# docker push us-central1-docker.pkg.dev/$GOOGLE_PROJECT/artemis/artemis:2.0.0
